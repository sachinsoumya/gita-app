...
export default function Third() {
    ...
    return (
        <div className='mt-5'>
            ...
            <div className='h2  font text-center my-2 text-decoration-underline pt-4'><i className="fas fa-om mx-2"></i>Chapter:{chapter} , Sloak : {verse_num}<i className="fas fa-om mx-2"></i></div>
            {image ?
